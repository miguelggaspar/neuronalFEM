...
# estimator = MLPRegressor(solver='lbfgs',
#                          activation='relu', learning_rate='adaptive',
#                          random_state=1)
# # #
# estimator = MLPRegressor(solver='adam', alpha=0.01,
...
hidden_sizes=[(9),(11),(22)]
# estimator.fit(X, y)
train_scores, valid_scores = validation_curve(estimator, X, y, "hidden_layer_sizes",
                                              hidden_sizes,
                                              cv=5)
param_range = np.linspace(1,3,3)
