...
hidden_sizes = [x for x in itertools.product(np.linspace(1, 15, 15, dtype=int),
                                             repeat=2)]
hidden_sizes.extend(np.linspace(1, 15, 15, dtype=int))
hidden_size_2 = [x for x in itertools.product(np.linspace(1, 15, 15, dtype=int),
                                              repeat=3)]
