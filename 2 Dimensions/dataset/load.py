...
save_graph(legend, 3, data, labels, 'graphs/dX_2d', 0)
...
save_graph(legend, 3, data, labels, 'graphs/X_2d', 0)
...
labels = ['Time [s]', 'Stress [MPa]']
save_graph(legend, 3, data, labels, 'graphs/S_2d', 0)

# Plot and save graphs of Drag stress and it's rate
legend = [r'$\dot R$', r'R']
data = [df['Time'], df['dR'], df['R']]
labels = ['Time [s]', 'Stress [MPa]']
save_graph(legend, 2, data, labels, 'graphs/R_dR_2d', 0)
...
save_graph(legend, 3, data, labels, 'graphs/ET_2d', 0)
...
labels = ['Time [s]', 'Strain [%]']
save_graph(legend, 3, data, labels, 'graphs/Ee_2d', 0)
...
labels = ['Time [s]', 'Strain [%]']
save_graph(legend, 3, data, labels, 'graphs/Ei_2d', 0)
