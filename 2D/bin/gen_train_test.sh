...
python ../dataset/src/viscoplasticity_model.py $1 $2 $3 $4 $5 $6 $7 $8 $9
# Make graphs for debugging
#python ../dataset/load.py $3 $4 $5
# Merge all trial's data to one .csv file
python ../dataset/src/merge_csv.py $3 $4 $5 $6 $7 $8 $9
...
# Test model
python3 ../testmodel/src/test_model.py $1 $2 $3 $4 $5 $6 $7 $8 $9
# Making graphs for debugging
python3 ../testmodel/src/compare.py $3 $4 $5 $6 $7 $8 $9
